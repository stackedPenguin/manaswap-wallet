// Adapted from @wallet-standard/wallet via Backpack
import type {
    Wallet,
    WalletEventsWindow,
...
export function registerWallet(wallet: Wallet): void {
    ...
    try {
        ...
        console.error('[Manaswap] wallet-standard:register-wallet event could not be dispatched\n', error);
    }
    try {
        ...
        console.error('[Manaswap] wallet-standard:app-ready event listener could not be added\n', error);
    }
}
